...
public class LusuoStream
{
    ...
    public int ReadInt(ref int uDate)
    {
        ...
        int iRef = m_stream.Read(bit, 0, StringHelper.s_IntSize);
    ...
    {
        byte[] bit = new byte[StringHelper.s_IntSize];
        m_stream.Read(bit, 0, StringHelper.s_IntSize);
    ...
    public int ReadUShort(ref ushort uDate)
    {
        ...
        int iRef = m_stream.Read(bit, 0, StringHelper.s_ShortSize);
    ...
    public int ReadBool(ref bool uDate)
    {
        ...
        int iRef = m_stream.Read(bit, 0, StringHelper.s_BoolSize);
    ...
    public bool ReadBool()
    {
        ...
        byte[] bit = new byte[StringHelper.s_BoolSize];
        m_stream.Read(bit, 0, StringHelper.s_BoolSize);
    ...
    public int ReadFloat(ref float uDate)
    {
        ...
        int iRef = m_stream.Read(bit, 0, StringHelper.s_FloatSize);
