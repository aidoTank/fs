...
public class TweenRotation : UITweener
{
	...
	override protected void OnUpdate (float factor, bool isFinished)
	{
        ...
        //cachedTransform.localEulerAngles = Vector3.Slerp(from, to, factor);
	}
    ...
    static public TweenRotation Get(GameObject go)
    {
        TweenRotation pos = go.GetComponent<TweenRotation>();
        if (pos == null)
            pos = go.AddComponent<TweenRotation>();
        return pos;
    }
}