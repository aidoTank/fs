...
{ 
    public class LusuoStream
    {
        ...
        public LusuoStream(int bufferSize)
        {
        ...
        byte[] uShortBit = new byte[StringHelper.s_ShortSize];
        public ushort ReadUShort()
        {
            ...
            m_stream.Read(uShortBit, 0, StringHelper.s_ShortSize);
            return BitConverter.ToUInt16(uShortBit, 0);
        }
